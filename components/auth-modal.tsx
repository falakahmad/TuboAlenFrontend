...
export default function AuthModal({ isOpen, onClose, onAuthenticated }: AuthModalProps) {
  ...
  const handleGoogleAuth = () => {
    // Google OAuth is not implemented - show error message
    setError("Google OAuth is not yet implemented. Please use email/password sign in.")
  }
  ...
  const handleSignin = async () => {
    ...
    try {
      ...
      // Save user data to localStorage and cookie for middleware-based route protection
      localStorage.setItem("turbo-alan-user", JSON.stringify({
        ...data.user,
