  ...
  return (
    <header className="relative z-20 flex items-center justify-between p-6">
      <div className="flex items-center gap-4">
        ...
        <Link href="/dashboard" className="text-white font-medium text-lg flex items-center gap-2">
      ...
      {/* Only show login/logout buttons when NOT on dashboard page (when showBackButton is false) */}
      {!showBackButton && (
        !authed ? (
          ...
          <button
            onClick={doLogout}
            className="px-4 py-2 rounded-full bg-white/10 text-white border border-white/20 text-xs hover:bg-white/20 transition-colors"
          >
            Sign out
          </button>
        )
